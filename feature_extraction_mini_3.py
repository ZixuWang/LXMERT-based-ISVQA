...
class FeatureExtractor:
    ...
    def __init__(self):
        self.args = self.get_parser().parse_args() # ArgumentParser通过parse_args()方法解析参数

        self.data = json.load(open(self.args.annotations_file))['data']
    ...
    def get_parser(self):
        ...
        parser.add_argument(
            "--output_folder", type=str, default="./feature_output", help="Output folder"
        )
        parser.add_argument("--image_dir", type=str, default="/Users/liyicong/Downloads/v1.0-mini/samples", help="Image directory or file")
        parser.add_argument("--annotations_file", default="./imdb_nuscenes_trainval.json", type=str)
        parser.add_argument(
            "--feature_name",
            type=str,
    ...
    def _process_feature_extraction(
        ...
        for i in range(batch_size):
            ...
            # if i == 0:
            #     feat_list = feats[i][keep_boxes]
            # else:
            #     feat_list = torch.cat((feat_list, feats[i][keep_boxes]))
            #bbox的得分
    ...
    def _save_feature(self, file_name, feature, info):
        ...
        #feature['feature'] = feature['feature'].cpu().numpy()
    ...
    def extract_features(self):
        for idx in range(len(self.data)):
            ...
            if image_id not in image_ids:
                ...
                #     # for j, img_dir in enumerate(self.image_dir):
                ...
                #     #     features = self.get_detectron_features(image_paths)
                #     #     self._save_feature('feature_'+str(idx), features[0])
                ...
                #     features, infos = self.get_detectron_features(image_paths)
                #     #features = self.get_detectron_features(image_paths)
                #     self._save_feature('feature_'+str(idx), features, infos)
                #     break
